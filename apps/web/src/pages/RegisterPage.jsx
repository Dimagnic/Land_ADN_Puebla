...
const RegisterPage = () => {
  ...
  const [form, setForm] = useState({
    nombre: '', email: '', telefono: '', interes: '', codigo_patrocinador: '', password: ''
  });
      ...
      <div className="min-h-screen flex items-center justify-center bg-background px-4 py-12">
        <div className="w-full max-w-md text-center">
          ...
          <p className="text-muted-foreground mb-6 leading-relaxed">
            Tu solicitud ha sido recibida. Un asesor se pondrá en contacto contigo pronto para darte acceso a la plataforma.
          </p>
        ...
        <div className="w-full max-w-md">
          ...
          <Card className="shadow-lg">
            <CardHeader>
              ...
              <CardDescription>Un asesor revisará tu solicitud y te dará acceso a la plataforma.</CardDescription>
            </CardHeader>
            <CardContent>
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  ...
                  <Input type="text" placeholder="Ej: Educación financiera, inversiones..." value={form.interes} onChange={set('interes')} className="mt-1" />
                </div>
                <div>
